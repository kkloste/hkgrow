...
% nohup /p/matlab-7.14/bin/matlab -nodisplay -nodesktop -nojvm -nosplash -r youtubecommunity > ytcomm.txt &

% dataset = 'youtube';
% load(dataset,'/scratch/yu163/youtube');
load /scratch/yu163/youtube/youtube;
...
save(['/scratch2/dgleich/kyle/kdd/' 'youtubecommunity' '.mat'],'bestfmeas','conds','avecommsize','recofbestfmeas','precofbestfmeas', 'bestrecsize', 'condofbestfmeas','bestrecsize','-v7.3');
exit;