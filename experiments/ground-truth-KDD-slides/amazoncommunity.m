...
% dataset = 'amazon';
% load(dataset,'/scratch/yu163/amazon');
load /scratch/yu163/amazon/amazon;
...
save(['/scratch2/dgleich/kyle/kdd/' 'amazoncommunity' '.mat'],'bestfmeas','conds','avecommsize','recofbestfmeas','precofbestfmeas', 'bestrecsize', 'condofbestfmeas','bestrecsize','-v7.3');
exit;
