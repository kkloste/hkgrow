...
% dataset = 'friendster';
% load(dataset,'/scratch/dlgeich/kyle/friendster/friendster');
% the .mat files containing the data are
% /scratch2/dgleich/kyle/com-friend/friendcommC.mat
% /scratch2/dgleich/kyle/com-friend/friendcommCtop.mat
% /scratch2/dgleich/kyle/symmats/friendster.mat

load /scratch2/dgleich/kyle/com-friend/friendcommC;
load /scratch2/dgleich/kyle/com-friend/friendcommCtop;
...
save(['/scratch2/dgleich/kyle/kdd/' 'friendstercommunity' '.mat'],'bestfmeas','conds','avecommsize','recofbestfmeas','precofbestfmeas', 'bestrecsize', 'condofbestfmeas','bestrecsize','-v7.3');
exit;