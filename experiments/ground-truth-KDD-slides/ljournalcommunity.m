...
% nohup /p/matlab-7.14/bin/matlab -nodisplay -nodesktop -nojvm -nosplash -r ljournalcommunity > ljcomm.txt &

% dataset = 'liveJournal';
% load(dataset,'/scratch/yu163/liveJournal');
load /scratch/yu163/liveJournal/liveJournal;
...
save(['/scratch2/dgleich/kyle/kdd/' 'ljournalcommunity' '.mat'],'bestfmeas','conds','avecommsize','recofbestfmeas','precofbestfmeas', 'bestrecsize', 'condofbestfmeas','bestrecsize','-v7.3');
exit;
