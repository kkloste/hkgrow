% nohup /p/matlab-7.14/bin/matlab -nodisplay -nodesktop -nojvm -nosplash -r experimenthkgrow > hkgrowsmall.txt &

% filename={'pgp-cc', 'ca-AstroPh-cc', 'marvel-comics-cc', 'as-22july06', 'rand-ff-25000-0.4', 'cond-mat-2003-cc', 'email-Enron-cc',
    % 'cond-mat-2005-fix-cc', 'soc-sign-epinions-cc', 'itdk0304-cc', 'dblp-cc', 'flickr-bidir-cc'};
filename = {'itdk0304-cc', 'dblp-cc'};
numtrials = 10;
tvals = 20;
eps = 1e-3;
